...
<div id="certificateUploader" class="modal fade">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">Загрузить файл сертификата</h4>
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-12 form-group">
						<input id="certificateFile" name="file" type="file" multiple placeholder="Выберите файл-картинку сертификата" >
					</div>
					<div class="col-12 form-group">
						<input id="certificateName" name="certificateName" class="form-control" placeholder="Название сертификата" required="required">
					</div>
					<div class="col-12 text-center">
						<a href="javascript:addCertificate()" class="btn btn-primary" >Добавить сертификат</a>
					</div>
				</div>
			</div>
		</div>
