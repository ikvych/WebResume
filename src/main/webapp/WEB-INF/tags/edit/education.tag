...
<div class="card-body border" style="margin-bottom: 1em">
    ...
    <div class="form-row">
        <div class="form-group col-md-12">
            ...
            <textarea name="items[${index}].summary" rows="3" type="text" class="form-control" id="inputPosition">${education.summary}</textarea>
<%--            <div class="row" >
                <div class="col-12">
...
<%--            <select name="items[${index }].beginYear" class="form-control" id="inputBeginYear">
        ...
        <div class="form-group col-md-6">
            <label <%--for="inputFinish"--%>>Finish year</label>
<%--            <select name="items[${index }].finishYear" class="form-control" id="inputFinish">
                <c:forEach var="year" items="${years}">
...
<%--            <div class="row" >
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input name="items[${index}].university" value="${education.university}" type="text" class="form-control" id="inputUniversity">
<%--            <div class="row" >
                <div class="col-12">
        ...
        <div class="form-group col-md-6">
            ...
            <input name="items[${index}].faculty" value="${education.faculty}" type="text" class="form-control" id="inputFaculty">
<%--            <div class="row" >
                <div class="col-12">
