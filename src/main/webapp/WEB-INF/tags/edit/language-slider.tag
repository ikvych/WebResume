...
<input name="items[${index }].level" id="items${index }level" style="width: 100%;" class="level-slider"
       data-slider-ticks="${languageLevelKeys }" data-slider-value="${value}" data-provide="slider" data-slider-tooltip="hide"
       data-slider-ticks-labels='${languageLevelValues }' data-slider-min="1" data-slider-max="7" data-slider-step="1">